...
module.exports.analyzeProject = async function analyzeProject(project, dataset) {
  ...
  for (var i = 0; i < Object.keys(dataset).length; i++) {
    ...
    totalDegress.keys = connectionsAmongProjects(dataset[project], Object.items(dataset)[i])
    totalDegress.count= connectionsAmongProjects(dataset[project], Object.items(dataset)[i]).length
